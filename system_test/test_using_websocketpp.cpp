...
{
	Si::absolute_path const app_source = repository / Si::relative_path("cdm/application/using_websocketpp");
	Si::absolute_path const tmp = Si::temporary_directory(Si::throw_) / *Si::path_segment::create("cdm_test_using_websocketpp");
