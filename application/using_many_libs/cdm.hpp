...
namespace CDM_CONFIGURE_NAMESPACE
{
	                                ...
	                                unsigned cpu_parallelism, Si::Sink<char, Si::success>::interface &output)
	{
		...
		cdm::libgit2_paths const libgit2installed =
		    cdm::install_libgit2(libgit2_source, module_temporaries, module_permanent, ventura::cmake_exe, cpu_parallelism, output);
		...
		cdm::websocketpp_paths const websocketpp_installed =
		    cdm::install_websocketpp(websocketpp_source, boost_source, module_temporaries, module_permanent, cpu_parallelism, output);
