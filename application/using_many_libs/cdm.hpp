...
namespace CDM_CONFIGURE_NAMESPACE
{
	                                ...
	                                Si::Sink<char, Si::success>::interface &output)
	{
		...
		ventura::absolute_path const cppnetlib_source =
		    *cdm / ventura::relative_path("original_sources/cpp-netlib-0.11.2-final");
		...
		ventura::absolute_path const rapidjson_source =
		    *cdm / ventura::relative_path("original_sources/rapidjson-1.0.2");
		...
		ventura::absolute_path const sqlite3_source =
