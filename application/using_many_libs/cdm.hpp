...
namespace CDM_CONFIGURE_NAMESPACE
{
		...
		)
	{
		...
		ventura::absolute_path const catch_source = *cdm / ventura::relative_path("original_sources/Catch-1.2.1");
		...
		ventura::absolute_path const libgit2_source = *cdm / ventura::relative_path("original_sources/libgit2-0.23.2");
		cdm::libgit2_paths const libgit2installed = cdm::install_libgit2(libgit2_source, module_temporaries, module_permanent, ventura::cmake_exe, cpu_parallelism, output);

		ventura::absolute_path const rapidjson_source = *cdm / ventura::relative_path("original_sources/rapidjson-1.0.2");
		...
		ventura::absolute_path const rapidxml_source = *cdm / ventura::relative_path("original_sources/rapidxml-1.13");
		...
		ventura::absolute_path const sqlite3_source = *cdm / ventura::relative_path("original_sources/sqlite-autoconf-3081101");
		cdm::sqlite_paths const sqlite3_installed = cdm::install_sqlite(sqlite3_source, module_temporaries, module_permanent, ventura::cmake_exe, output);

		ventura::absolute_path const websocketpp_source = *cdm / ventura::relative_path("original_sources/websocketpp-c5510d6de04917812b910a8dd44735c1f17061d9");
