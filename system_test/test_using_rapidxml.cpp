...
BOOST_AUTO_TEST_CASE(test_using_rapidxml)
{
	...
	ventura::absolute_path const tmp = ventura::temporary_directory(Si::throw_) / "cdm_test_using_rapidxml";
	...
	std::unique_ptr<std::ofstream> log_file = cdm::open_log(tmp / "test_using_rapidxml.txt");
