...
namespace CDM_CONFIGURE_NAMESPACE
{
		...
		)
	{
		...
		ventura::absolute_path const original_source = *cdm / ventura::relative_path("original_sources/sqlite-autoconf-3081101");
		cdm::sqlite_paths const installed = cdm::install_sqlite(original_source, module_temporaries, module_permanent, ventura::cmake_exe, output);
